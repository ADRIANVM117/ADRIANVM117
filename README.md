...
|[Bayesian_Fair_Value_Estimation_and_Mispricing_Detection_in_Prediction_Markets](https://github.com/ADRIANVM117/data-science-portfolio/tree/main/Bayesian_Fair_Value_Estimation_and_Mispricing_Detection_in_Prediction_Markets)    | The objective of this project is to investigate whether Bayesian methods can identify systematic mispricing in prediction markets by estimating a fair probability and comparing it against the market-implied probability. The ultimate goal is to determine whether these discrepancies can generate exploitable trading signals.| 
